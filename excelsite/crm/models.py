...
class Company (models.Model):
    ...
    photo = models.ImageField(upload_to="partners/", null=False, blank=True, verbose_name='Фото')
    is_published = models.BooleanField(default=True, verbose_name='Публикация')

    def get_absolute_url (self): return reverse('partner_ref',kwargs={'partner_id':self.pk})
